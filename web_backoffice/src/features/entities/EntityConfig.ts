...
export const ENTITIES: EntityDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'age_group', label: 'Age Group', type: 'select', options: ['child', 'teen', 'adult', 'senior'], editable: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'category', label: 'Category', type: 'select', options: ['top', 'bottom', 'dress', 'outerwear', 'footwear', 'accessory'], editable: true },
